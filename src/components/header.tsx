      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4 lg:gap-8">
            {/* Mobile Menu Trigger - Moved to the start for better mobile layout */}
             <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
                ...
                <SheetContent side="right" className="w-[300px] sm:w-[350px] bg-background" dir="rtl">
                  <SheetHeader className="mb-6 border-b pb-4 flex flex-row items-center justify-between">
                    ...
                    <ul className="grid w-[450px] gap-3 p-4 md:w-[550px] md:grid-cols-2 lg:w-[650px]">
                      {categories.map((category) => (
                        <ListItem
                          ...
                          className="text-right hover:bg-secondary" // Ensure text aligns right within the list item
                        >
          ...
          <div className="flex items-center space-x-2 sm:space-x-3 rtl:space-x-reverse">
             <div className="relative hidden sm:block">
                <Input
                  ...
                  className="bg-secondary border-none px-4 py-2 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-ring w-48 md:w-64 transition-all duration-300 focus:w-64 md:focus:w-72 pl-10 rtl:pr-10"
            ...
            <Button variant="ghost" size="icon" className="relative transition-transform hover:scale-110 duration-300 text-muted-foreground hover:text-foreground">
              <Bell className="h-5 w-5" />
              {/* Adjusted badge position for RTL */}
              <span className="absolute -top-1 -left-1 rtl:-right-1 rtl:-left-auto bg-destructive text-destructive-foreground text-[10px] font-bold rounded-full w-4 h-4 flex items-center justify-center animate-pulse">
                ۳
              </span>
