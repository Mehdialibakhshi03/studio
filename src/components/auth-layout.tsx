...
const AuthLayout: React.FC<AuthLayoutProps> = ({
  children,
  title,
  illustrationUrl = "https://placehold.co/1200x800.png", // Default placeholder
  illustrationAlt = "Authentication Illustration",
  illustrationAiHint = "abstract security login"
}) => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-secondary via-background to-secondary/70 flex flex-col justify-center items-center p-4 sm:p-6 lg:p-8" dir="rtl">
      ...
      <div className="w-full max-w-4xl lg:max-w-5xl bg-card shadow-2xl rounded-xl overflow-hidden lg:grid lg:grid-cols-2 animate-fade-in animation-delay-200">
        <div className="p-6 sm:p-8 lg:p-12 flex flex-col justify-center">
          <div className="mb-8 text-center lg:text-right">
            <h1 className="text-3xl sm:text-4xl font-bold text-primary mb-2">{title}</h1>
            <p className="text-muted-foreground">به پلتفرم خرید گروهی خوش آمدید!</p>
          </div>
          {children}
        </div>
